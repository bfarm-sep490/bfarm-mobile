...
export const taskReportUpdateResponseSchema = z.object({
  ...
  data: z.object({
    ...
    updated_at: z.string(),
    updated_by: z.string(),
    plan_information: z.any().nullable(),
    problem: z.any().nullable(),
    caring_images: z.any().nullable(),
    caring_pesticides: z.any().nullable(),
    caring_fertilizers: z.any().nullable(),
    caring_items: z.any().nullable(),
    farmer_information: z.any().nullable(),
  }),
});
